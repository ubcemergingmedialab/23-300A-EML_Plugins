...
void FEML_Core_UnrealCommands::RegisterCommands()
{
	...
	UI_COMMAND(CodingStandards, "EML Coding Standards", "Read more about the coding standards for Emerging Media Lab UBC Projects.", EUserInterfaceActionType::Button, FInputChord());
